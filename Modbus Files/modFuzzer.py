...
'''
def main():
	target_host = '87.255.162.35'
	target_port = 502

	# tcp_connection = BaseSocketConnection(host=target_host, port=target_port, proto='tcp')
	session = Session(
			target=Target(
				connection=BaseSocketConnection(target_host, target_port, proto='tcp')))
